...
<div style={{width:'95%',backgroundColor:'#ddd',marginTop:'5px'}}>
  <div style={{...style,textAlign:'right',color:'white',width:`${percentage}`,fontSize:'15px'}}>{name}   {percentage}</div>
      ...
      <Button onClick={handleOpen} variant="contained" sx={{display:'flex',justifyContent:'right' ,backgroundColor:'#ffd066',color:'black',my:'50px',fontWeight:'bold'}}
      ...
      >
        <Box sx={{...style,width:{xs:'100%',sm:'50%',md:'auto'}}} style={{backgroundColor:'#033d58',color:'white'}}>
          <Typography id="modal-modal-title" variant="h6" component="h2">
            Detailed Skills
          </Typography>
          <Typography id="modal-modal-description" sx={{ mt: 2,textAlign:'left' }}>
            As a computer science student I have also applicable knowledge about core concepts of Structured Programming, Data Structure, Object Oriented Programming, Algorithm and so on.<br/><br/>
